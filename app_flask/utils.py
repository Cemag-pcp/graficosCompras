...
def dados_grafico_serrote(produto_escolhido,grupo_escolhido,df_simulacao, df_pedidos):
    ...
    if grupo_escolhido:
        ...
        return datas,datas_grafico,datas_ideal_grafico,estoque_ideal_diario,estoque_diario
