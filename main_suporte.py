...
with aba1:
    with st.sidebar:
        produto_escolhido = st.selectbox(
            "Selecione o produto:",
            ["Selecione..."] + list(df_simulacao_teste['Código'].unique())
        )
    ...
    # Cria DataFrame filtrado de acordo com o radio
    ...
    if filtro == "Apenas itens urgentes":
        ...
        df_filtrado = df_filtrado[df_filtrado["dias_ate_data_compra"] == 0]
    # "Mostrar tudo" não filtra nada adicional
    ...
    if produto_escolhido != 'Selecione...':
        ...
        st.write("Para ver os gráficos escolha um produto ou um grupo.")
